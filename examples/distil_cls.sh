...
# teacher_model_name_or_path=outputs/quaero/drbert_7gb_ft_ep100_bs32_lr5e5_cosine_ntr-fl
# teacher_model_name_or_path=outputs/quaero/drbert_7gb_large_ft_ep100_bs32_lr5e5_cosine_ntr-fl
teacher_model_name_or_path=outputs/quaero/camembert_large_ft_ep100_bs32_lr5e5_cosine_ntr-fl
...
output_dir=${model_name_or_path}-distil-${pretty_teacher_model_name}-ep150-bs32-lr5e5-cosine-${criterion_name}-temp05
